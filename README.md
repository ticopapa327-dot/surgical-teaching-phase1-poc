...
- 状态区显示视频码率、丢包、音频缓冲、jitter、RTT 和 ICE 候选类型路由，便于判断黑屏、延迟或 TURN/relay 路径问题。
- 提供“复制诊断快照”，输出控制面、通道、音频、媒体、PeerConnection 和最近 10 条信令事件摘要；快照不包含信令令牌、设备 ID、患者信息、SDP、ICE candidate 原文或媒体数据。
